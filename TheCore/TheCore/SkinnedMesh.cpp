...
{
	if(FAILED(D3DXCreateEffectFromFile(pDxDevice,"../../../TheCore/TheCore/TheCore/shaders/SkinnedMeshShader.fx",0,0,D3DXSHADER_DEBUG,0,&m_pEffect,0)))
	{
...
{
	D3DXCreateEffectFromFile(pDxDevice, "../../../TheCore/TheCore/TheCore/shaders/Text3DShader.fx", 0, 0, D3DXSHADER_DEBUG, 0, &m_pTitlesEffect, 0);
