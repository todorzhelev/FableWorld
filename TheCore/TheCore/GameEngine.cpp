...
{
	if( pEngine && pEngine->GetCurrentScene() != NULL )
	{
		return pEngine->GetCurrentScene()->MsgProc(msg, wParam, lParam);
	}
	else
	{
...
/////////////////////////////////////////////////////////////////////////
/*
Function:GamepEngine
Purpose:constructor
*/
GameEngine::GameEngine(HINSTANCE hInstance, string strWindowTitle, D3DDEVTYPE eDeviceType, DWORD vertexProcessingType)
{
...
*/
HINSTANCE GameEngine::GetAppInstance()
{
...
*/
D3DPRESENT_PARAMETERS GameEngine::GetPresentParameters()
{
...
void GameEngine::SetPaused(bool bPaused)
{
...
*/
void GameEngine::SwitchToFullscreen(bool bSwitch)
{
...
IDirect3DVertexDeclaration9* GameEngine::GetPositionNormalTextureDecl()
{ 
...
void GameEngine::SetPositionNormalTextureDecl(IDirect3DVertexDeclaration9* pDecl)
{
...
IDirect3DVertexDeclaration9* GameEngine::GetPosColDeclaration()
{ 
...
void GameEngine::SetPosColDeclaration(IDirect3DVertexDeclaration9* pDecl)
{
...
void GameEngine::SetCurrentScene(IBaseScene* pScene)
{
...
IBaseScene* GameEngine::GetCurrentScene()
{
...
void GameEngine::AddScene(string strSceneName, IBaseScene* pScene)
{
...
IBaseScene* GameEngine::GetScene(string strSceneName)
{
...
bool GameEngine::IsShaderVersionSupported()
{
	D3DCAPS9 caps;
...
void GameEngine::AddUIObject(IBaseMenuObject* pUIObject)
{
...
IBaseMenuObject* GameEngine::FindMenuObject(string strObjectId)
{
...
void GameEngine::InitDebugGraphicsShader()
{
...
*/
void GameEngine::DrawLine(const D3DXVECTOR3& vStart, const D3DXVECTOR3& vEnd)
{
