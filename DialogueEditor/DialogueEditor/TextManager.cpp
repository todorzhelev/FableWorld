...
*/
void TextManager::CreateMeshFor3DText(string strText, ID3DXMesh*& pMesh)
{
	D3DXCreateText(pDxDevice,  
					m_hDC,          
					strText.c_str(),		//Text 
					0.001f,            
					0.0001f,    //controls the text depth in z direction, small numbers will make it look thin      
					&pMesh,			//Mesh
					NULL,       
					NULL);
}
