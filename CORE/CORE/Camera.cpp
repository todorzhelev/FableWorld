...
void Camera::GetWorldPickingRay(D3DXVECTOR3& vOrigin, D3DXVECTOR3& vDirection) {
	...
	float x = (2.0f * pCursorPosition.x / w - 1.0f) / m_ProjectionMatrix(0, 0);
	float y = (-2.0f * pCursorPosition.y / h + 1.0f) / m_ProjectionMatrix(1, 1);
